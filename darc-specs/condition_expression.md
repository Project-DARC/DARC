...
| 266 | BATCH_OP_ANY_TARGET_ADDRESS_TOTAL_VOTING_WEIGHT_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
...
| 269 | BATCH_OP_EACH_TARGET_ADDRESS_TOTAL_DIVIDEND_WEIGHT_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
...
| 272 | BATCH_OP_ANY_TARGET_ADDRESS_TOTAL_DIVIDEND_WEIGHT_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 273 | BATCH_OP_EACH_TARGET_ADDRESS_OWNS_TOKEN_X_GREATER_THAN | UINT256_2DARRAY[0][0] tokenClass, UINT256_2DARRAY[0][0] amount ||
| 274 | BATCH_OP_EACH_TARGET_ADDRESS_OWNS_TOKEN_X_LESS_THAN | UINT256_2DARRAY[0][0] tokenClass, UINT256_2DARRAY[0][0] amount ||
| 275 | BATCH_OP_EACH_TARGET_ADDRESS_OWNS_TOKEN_X_IN_RANGE | UINT256_2DARRAY[0][0] tokenClass, UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 276 | BATCH_OP_ANY_TARGET_ADDRESS_OWNS_TOKEN_X_GREATER_THAN | UINT256_2DARRAY[0][0] tokenClass, UINT256_2DARRAY[0][0] amount |
| 277 | BATCH_OP_ANY_TARGET_ADDRESS_OWNS_TOKEN_X_LESS_THAN | UINT256_2DARRAY[0][0] tokenClass, UINT256_2DARRAY[0][0] amount |
| 278 | BATCH_OP_ANY_TARGET_ADDRESS_OWNS_TOKEN_X_IN_RANGE | UINT256_2DARRAY[0][0] tokenClass, UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount |
| 279 | Placeholder279  |  |  |
| 280 | Placeholder280  |  |  |
| 281 | Placeholder281  |  |  |
| 282 | Placeholder282  |  |  |
...
| 299 | Placeholder299  |  |  |
| 300 | Placeholder300  |  |  |
| 301 | ENABLE_PLUGIN_INDEX_IN_LIST | UINT256_2DARRAY[0] pluginIndexList ||
| 302 | ENABLE_PLUGIN_INDEX_IN_RANGE | UINT256_2DARRAY[0][0] startPluginIndex, UINT256_2DARRAY[0][0] endPluginIndex ||
| 303 | ENABLE_PLUGIN_INDEX_EQUALS | UINT256_2DARRAY[0][0] pluginIndex ||
| 304 | ENABLE_PLUGIN_INDEX_GREATER_THAN | UINT256_2DARRAY[0][0] pluginIndex ||
| 305 | ENABLE_PLUGIN_INDEX_LESS_THAN | UINT256_2DARRAY[0][0] pluginIndex ||
| 306 | DISABLE_PLUGIN_INDEX_IN_LIST | UINT256_2DARRAY[0] pluginIndexList ||
| 307 | DISABLE_PLUGIN_INDEX_IN_RANGE | UINT256_2DARRAY[0][0] startPluginIndex, UINT256_2DARRAY[0][0] endPluginIndex ||
| 308 | DISABLE_PLUGIN_INDEX_EQUALS | UINT256_2DARRAY[0][0] pluginIndex ||
| 309 | DISABLE_PLUGIN_INDEX_GREATER_THAN | UINT256_2DARRAY[0][0] pluginIndex ||
| 310 | DISABLE_PLUGIN_INDEX_LESS_THAN | UINT256_2DARRAY[0][0] pluginIndex ||
| 311 | IS_PLUGIN_BEFORE_OPERATION |  ||
| 312 | IS_PLUGIN_AFTER_OPERATION |  ||
| 313 | ADD_PLUGIN_LEVEL_EQUALS | UINT256_2DARRAY[0][0] pluginIndex, UINT256_2DARRAY[0][0] level ||
| 314 | ADD_PLUGIN_LEVEL_IN_LIST | UINT256_2DARRAY[0] pluginIndexList ||
| 315 | ADD_PLUGIN_LEVEL_IN_RANGE | UINT256_2DARRAY[0][0] startPluginIndex, UINT256_2DARRAY[0][0] endPluginIndex, UINT256_2DARRAY[0][0] level ||
| 316 | ADD_PLUGIN_LEVEL_GREATER_THAN | UINT256_2DARRAY[0][0] pluginIndex, UINT256_2DARRAY[0][0] level ||
| 317 | ADD_PLUGIN_LEVEL_LESS_THAN | UINT256_2DARRAY[0][0] pluginIndex, UINT256_2DARRAY[0][0] level ||
| 318 | ADD_PLUGIN_RETURN_TYPE_EQUALS | UINT256_2DARRAY[0][0] pluginIndex, UINT256_2DARRAY[0][0] returnType ||
| 319 | ADD_PLUGIN_VOTING_RULE_INDEX_IN_LIST |  UINT256_2DARRAY[0] votingRuleIndexList ||
| 320 | Placeholder320  |  |  |
| 321 | Placeholder321  |  |  |
| 322 | Placeholder322  |  |  |
| 323 | Placeholder323  |  |  |
...
| 429 | Placeholder429  |  |  |
| 430 | Placeholder430  |  |  |
| 431 | ADD_WITHDRAWABLE_BALANCE_EACH_AMOUNT_GREATER_THAN | UINT256_2DARRAY[0][0] amount ||
| 432 | ADD_WITHDRAWABLE_BALANCE_EACH_AMOUNT_LESS_THAN | UINT256_2DARRAY[0][0] amount ||
| 433 | ADD_WITHDRAWABLE_BALANCE_EACH_AMOUNT_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 434 | ADD_WITHDRAWABLE_BALANCE_EACH_AMOUNT_EQUALS | UINT256_2DARRAY[0][0] amount ||
| 435 | REDUCE_WITHDRAWABLE_BALANCE_EACH_AMOUNT_GREATER_THAN | UINT256_2DARRAY[0][0] amount ||
| 436 | REDUCE_WITHDRAWABLE_BALANCE_EACH_AMOUNT_LESS_THAN | UINT256_2DARRAY[0][0] amount ||
| 437 | REDUCE_WITHDRAWABLE_BALANCE_EACH_AMOUNT_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 438 | Placeholder438  |  |  |
| 439 | Placeholder439  |  |  |
| 440 | Placeholder440  |  |  |
| 441 | Placeholder441  |  |  |
...
| 459 | Placeholder459  |  |  |
| 460 | Placeholder460  |  |  |
| 461 | PAY_TO_MINT_PRICE_GREATER_THAN | UINT256_2DARRAY[0][0] amount ||
| 462 | PAY_TO_MINT_PRICE_LESS_THAN | UINT256_2DARRAY[0][0] amount ||
| 463 | PAY_TO_MINT_PRICE_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 464 | PAY_TO_MINT_PRICE_EQUALS | UINT256_2DARRAY[0][0] amount ||
| 465 | PAY_TO_TRANSFER_PRICE_GREATER_THAN | UINT256_2DARRAY[0][0] amount ||
| 466 | PAY_TO_TRANSFER_PRICE_LESS_THAN | UINT256_2DARRAY[0][0] amount ||
| 467 | PAY_TO_TRANSFER_PRICE_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 468 | PAY_TO_TRANSFER_PRICE_EQUALS | UINT256_2DARRAY[0][0] amount ||
| 469 | BURN_AND_REFUND_PRICE_GREATER_THAN | UINT256_2DARRAY[0][0] amount ||
| 470 | BURN_AND_REFUND_PRICE_LESS_THAN | UINT256_2DARRAY[0][0] amount ||
| 471 | BURN_AND_REFUND_PRICE_IN_RANGE | UINT256_2DARRAY[0][0] startAmount, UINT256_2DARRAY[0][0] endAmount ||
| 472 | BURN_AND_REFUND_PRICE_EQUALS | UINT256_2DARRAY[0][0] amount ||
| 473 | Placeholder473  |  |  |
| 474 | Placeholder474  |  |  |
| 475 | Placeholder475  |  |  |
| 476 | Placeholder476  |  |  |
